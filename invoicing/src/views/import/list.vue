  ...
  <div class="app-container">
    ...
    <el-form :inline="true" class="demo-form-inline">
      ...
      <center>
        ...
        <el-button type="warning" icon="el-icon-plus" @click="addData()">进货</el-button>
      </center>
    </el-form>
    <br>
    ...
    >
      <el-form ref="form" :model="form" label-width="80px">
        ...
        <el-form-item label="进货数量" prop="count">
    ...
    >
      ...
      <el-table-column v-if="false" prop="importid" label="出货id" width="250" align="center" />
...
<script>
import importt from '@/api/import'
export default {
  data() { // 定义数据
    return {
      dialog: false,
  ...
  methods: {
    fetchData(page = 1) { // 调用api层获取数据库中的数据
      ...
      importt.list(this.page, this.limit, this.searchObj).then(response => {
    ...
    saveInfo(form) {
      if (this.add === true) {
        if (this.form.count && this.form.goodid) {
          importt.save(this.form).then(response => {
            this.fetchData()
            return this.$message({
              type: 'success',
              message: '保存成功!'
    ...
    changeOption(params) {
      ...
      // importt.getCountByGoodId(goodid).then(response => {
